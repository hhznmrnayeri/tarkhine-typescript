...
import { HeaderSliderType } from "../types/HeaderSlider.types";
export default function HeaderSlider({ title }: HeaderSliderType) {
  return (
    <div className="header w-full h-44 md:h-80 relative">
      ...
      <NavLink
        to="/menu"
        className="md:font-estedadMedium text-2xs md:text-base rounded bg-primary p-2 md:px-4 text-white text-center flex-center absolute z-10 h-6 w-24 md:h-10 md:w-48 left-0 right-0 mx-auto bottom-10 md:bottom-16"
      >
        سفارش آنلاین غذا
      </NavLink>
      {/* navigation box */}
