...
export default function Nav(props: NavProps) {
  ...
  const [listItems] = useState([
    ...
    },
    {
      ...
      icon: null,
      submenu: [
        { name: "اکباتان", icon: null },
        { name: "چالوس", icon: null },
        { name: "اقدسیه", icon: null },
        { name: "ونک", icon: null },
      ],
      href: "branch",
    },
    {
      ...
      icon: null,
      submenu: [
        { name: "غذای اصلی", icon: null },
        { name: "پیش غذا", icon: null },
        { name: "دسر", icon: null },
        { name: "نوشیدنی", icon: null },
      ],
      href: "menu",
    },
    {
  ...
  return (
    <>
      ...
      {showMobileMenu && (
        <Overlay onHide={toggleMenu}>
          {/* mobile menu  */}
          <div
            className={`fixed bg-white top-0 h-full w-64 z-30 md:hidden transition-all duration-300 ${
