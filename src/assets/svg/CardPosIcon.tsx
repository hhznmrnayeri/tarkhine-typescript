...
export default function CardPosIcon({ size }: Icon): React.ReactNode {
  return (
    <svg className={`${size}`} fill="none" viewBox="0 0 24 25">
      <path
        fill="#717171"
        d="M3.93 17.13c-.19 0-.38-.07-.53-.22a.754.754 0 010-1.06L15.35 3.9c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06L4.46 16.92c-.14.14-.34.21-.53.21zM11.1 19.53c-.19 0-.38-.07-.53-.22a.754.754 0 010-1.06l1.2-1.2c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-1.2 1.2a.75.75 0 01-.53.22zM13.79 16.84c-.19 0-.38-.07-.53-.22a.754.754 0 010-1.06l2.39-2.39c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-2.39 2.39c-.14.14-.34.22-.53.22z"
      ></path>
      <path
        fill="#717171"
