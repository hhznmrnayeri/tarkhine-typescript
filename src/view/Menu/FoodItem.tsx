    ...
    <>
          ...
          <div className="flex items-end gap-2 justify-between w-full md:gap-4">
            ...
            <div className="flex flex-col items-end gap-2 md:gap-0">
              ...
              <span className="text-2xs md:text-lg flex flex-shrink-0">
                <span>{ConvertToPersian({ num: props.priceValue })}</span> تومان
              </span>
            </div>
          </div>
          {/* bottom box */}
      ...
      {showGalleryModal && (
        <Overlay onHide={closeGalleryModal}>
          <div
            className={`food__gallery fixed rounded-lg bg-white overflow-hidden w-11/12 md:w-9/12 xl:w-7/12 h-[90%] md:h-3/4 inset-0 m-auto z-30 flex flex-col transition-all duration-300 ${
          ...
          >
            <div className="bg-gray-300 py-2 px-6 flex items-center justify-between order-1">
              <h4 className="font-estedadSemiBold text-sm md:text-2xl mx-auto">
                اطلاعات محصول
              </h4>
              <button
                onClick={closeGalleryModal}
                className="absolute top-1 left-6 z-40"
              >
              ...
              <div className="flex flex-col items-end gap-1">
                ...
                <span className="text-sm text-gray-400">
                  ...
                  <span className="comment__count">
                    {ConvertToPersian({ num: props.comment })}
                  </span>{" "}
                  نظر)
                </span>
              </div>
            ...
            >
              ...
              <SwiperSlide>
                <img
                  src="src/assets/images/menu/food1.webp"
                  className="w-full h-full object-cover"
                />
              </SwiperSlide>
              <SwiperSlide>
                <img
                  src="src/assets/images/menu/food2.webp"
                  className="w-full h-full object-cover"
                />
              </SwiperSlide>
              <SwiperSlide>
                <img
                  src="src/assets/images/menu/food3.webp"
                  className="w-full h-full object-cover"
                />
              </SwiperSlide>
              <SwiperSlide>
                <img
                  src="src/assets/images/menu/food4.webp"
                  className="w-full h-full object-cover"
                />
              </SwiperSlide>
              <SwiperSlide>
                <img
                  src="src/assets/images/menu/food5.webp"
                  className="w-full h-full object-cover"
                />
              </SwiperSlide>
              <SwiperSlide>
                <img
                  src="src/assets/images/menu/food6.webp"
                  className="w-full h-full object-cover"
                />
              </SwiperSlide>
              <SwiperSlide>
                <img
                  src="src/assets/images/menu/food7.webp"
                  className="w-full h-full object-cover"
                />
              </SwiperSlide>
            </Swiper>
